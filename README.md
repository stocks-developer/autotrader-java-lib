# AutoTrader Web Java Library: Broker-Independent Trading API for 40+ Indian Brokers

> Place, modify, cancel and track orders across **40+ Indian brokers** from your own **Java** code. Write your logic once, trade on any broker, and never change a line of code to switch. Part of **[AutoTrader Web](https://stocksdeveloper.in/)** by **Stocks Developer**.
...
[![In operation](https://img.shields.io/badge/in%20operation-8%2B%20years-orange)](https://stocksdeveloper.in/about/)
...
The **AutoTrader Web Java library** (`com.dakshata:at-api`) is a broker-independent trading client for the JVM. You write your strategy once in Java and run it against any broker that AutoTrader Web supports. The same function calls work on every broker, so changing broker does not mean rewriting your code.
...
- **APIs and SDKs.** Java, Python, C# and Excel, plus AmiBroker, MetaTrader and HTTP REST / CSV.
...
Add the AutoTrader Web Maven repository and the `at-api` dependency to your build.
...
Full step-by-step guide: **[Java library setup](https://stocksdeveloper.in/documentation/client-setup/java-library/)**. Get your API key from your [account settings](https://webx.stocksdeveloper.in/register).
